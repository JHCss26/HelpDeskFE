...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchTickets = async () => {
      try {
        const { data } = await axios.get("/api/tickets/my/active");
        setTickets(data);
      } catch (err) {
  ...
  return (
    <div className=" flex-1 flex flex-col bg-gray-50">
      ...
      <div className="h-1/6 flex justify-between border-b border-b-[#d9d9d9] shadow-[2px_0_6px_0_hsla(0,0%,76.1%,0.5)] z-20 bg-[#fff]">
        <div className="flex items-center justify-between px-15 md:px-8 sm:px-4 py-2 w-full">
          <div className="flex items-center space-x-4 justify-start">
            ...
            <div className="text-base md:text-md sm:text-sm lg:text-xl xl:text-2xl font-[700] mb-[14px] leading-[normal] block">
      ...
      <div className="flex flex-col  w-full bg-gray-50 px-10 py-8">
